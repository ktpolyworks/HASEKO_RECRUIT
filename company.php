		...
		<main class="main">
			...
			<div class="pg company" id="company">
				...
				<section class="aboutgroup" id="aboutgroup">
					<div class="inner">
						<h2><img src="./assets/images/company_aboutgroup_title.webp" alt="長谷工グループとは" width="316" height="53"></h2>
						<div class="wrap">
							<div class="txt">
							...
							<div class="img"><img src="./assets/images/company_aboutgroup.webp" alt="" width="" height=""></div>
						</div>
						<div class="zu"><img src="./assets/images/company_aboutgroup_zu.webp" alt="" width="" height=""></div>
					</div>
				</section>
