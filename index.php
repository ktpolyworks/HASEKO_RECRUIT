		...
		<main class="main">
			...
			<div class="home" id="home">
				...
				<section class="visual" id="visual">
					<div class="pc">
						<div class="wrap">
							<div class="l"><img src="./assets/images/visual_1_1.webp" alt="" width="960" height="960"></div>
							<div class="r">
								<div class="r__1"><img src="./assets/images/visual_1_2.webp" alt="" width="960" height="480"></div>
								<div class="r__2"><img src="./assets/images/visual_1_3.webp" alt="" width="960" height="480"></div>
							</div>
						</div>
					</div>
					<div class="sp">
						<div class="wrap">
							<div class="l"><img src="./assets/images/visual_2_1_sp.webp" alt="" width="375" height="307"></div>
							<div class="r">
								<div class="r__1"><img src="./assets/images/visual_2_2_sp.webp" alt="" width="187" height="307"></div>
								<div class="r__2"><img src="./assets/images/visual_2_3_sp.webp" alt="" width="187" height="307"></div>
							</div>
						</div>
					</div>
				...
				<section class="concept" id="concept">
					...
					<!-- <div class="obj" id="obj__1"><img src="./assets/images/obj_1.svg" alt=""></div>
					<div class="obj" id="obj__2"><img src="./assets/images/obj_2.svg" alt=""></div> -->
				</section>
					...
					<div class="inner">
						<div class="first">
							<div class="box box__1">
								...
								<div class="more"><a href="./company.php" aria-label="会社を知るページへ移動">READ MORE</a></div>
							</div>
							<div class="box box__2">
								...
								<div class="more"><a href="./works.php" aria-label="仕事を知るページへ移動">READ MORE</a></div>
							</div>
						</div>
						<div class="second">
							<div class="box">
								...
								<div class="more"><a href="./person.php" aria-label="人を知るページへ移動">READ MORE</a></div>
								<div class="list">
									<ul>
										<li>
											<a href="./person.php#" aria-label="">
												<div class="img">
													<picture>
														<source srcset="./assets/images/home_person_1.webp" media="(min-width:769px)">
				...
				<section class="system" id="system">
					<div class="inner">
						...
						<div class="more"><a href="" aria-label="">READ MORE</a></div>
					</div>
				</section>
				...
				<section class="recruit" id="recruit">
					<div class="inner">
						...
						<div class="btns">
							<ul>
								<li><a href="" target="_blank" rel="noopener noreferrer" aria-label="ENTRYへ移動"><img src="./assets/images/btn_entry.webp" alt="ENTRY" width="659" height="136"></a></li>
								<li><a href="" target="_blank" rel="noopener noreferrer" aria-label="MYPAGEへ移動"><img src="./assets/images/btn_mypage.webp" alt="MYPAGE" width="659" height="136"></a></li>
							</ul>
						</div>
					</div>
				</section>
