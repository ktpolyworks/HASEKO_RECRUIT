	...
	<body id="top">
		...
		<main class="main">
			...
			<div class="pg recruit" id="recruit">
							...
							<ul>
								<li>
									...
									<div class="txt">
										...
										<p>弊社の選考応募を検討されている⽅は、まずは<a href="" aria-label="エントリーへ移動" target="_blank" rel="noopener noreferrer">エントリー</a>し会社説明会にお越しください。</p>
									</div>
								</li>
								<li>
							...
							<div class="box">
								<div class="wrap">
									...
									<dl>
										...
										<dd><a href="mailto:cqm_saiyo@haseko.co.jp" aria-label="メールを送信する">cqm_saiyo@haseko.co.jp</a></dd>
									</dl>
								</div>
							</div>
						</div>
				...
				<section class="recruit__entries" id="entry">
					<div class="inner">
						<div class="entries">
							<h3>エントリーはこちらから</h3>
							<ul>
